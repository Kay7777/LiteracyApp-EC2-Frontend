...
class MeaningTutorTrainOneAssign extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount = async () => {
    const doc = await axios.get(
      "/api/meaning/assign/" + this.props.match.params.id
    );
...
export default MeaningTutorTrainOneAssign;

...
class PhonemeTutorMaterials extends React.Component {
  ...
  handleMaterialsAdd = async () => {
    ...
    if (!!file) {
      ...
      if (section === "w1v1") {
        await axios.post("/api/phoneme/materials/w1v1",
          { desc: w1v1Desc, video: uploadConfigs.key });
      } else if (section === "w1v2") {
        await axios.post("/api/phoneme/materials/w1v2",
          { desc: w1v2Desc, video: uploadConfigs.key });
      } else if (section === "w2v1") {
        await axios.post("/api/phoneme/materials/w2v1",
          { desc: w2v1Desc, video: uploadConfigs.key });
      } else if (section === "w2v2") {
        await axios.post("/api/phoneme/materials/w2v2",
  ...
  handleMaterialsDelete = async () => {
    ...
    if (section === "w1v1") {
      await axios.delete("/api/phoneme/materials/w1v1");
    } else if (section === "w1v2") {
      await axios.delete("/api/phoneme/materials/w1v2");
    } else if (section === "w2v1") {
      await axios.delete("/api/phoneme/materials/w2v1");
    } else if (section === "w2v2") {
      await axios.delete("/api/phoneme/materials/w2v2");
    }
    this.componentDidMount();
  };

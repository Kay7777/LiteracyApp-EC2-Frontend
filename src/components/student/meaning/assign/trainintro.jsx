...
class MeaningTestIntro extends React.Component {
  ...
  renderButtons = () => {
    ...
    if (section === "w1") {
      if (currentUser.meaning_score.length === 1) {
        switch (currentUser.meaning_progress.w1) {
          case "":
            return (
              <Button
                variant="contained"
            ...
            return (
              <div>
                <Button
                  ...
                  onClick={() =>
                    this.props.handleClick(currentUser.meaning_progress.w1, "w1")
                  }
                >
      ...
      } else if (currentUser.meaning_score.length === 2) {
        switch (currentUser.meaning_progress.w2) {
          case "":
            return (
              <Button
                variant="contained"
            ...
            return (
              <div>
                <Button
                  ...
                  style={{ marginLeft: 20, marginRight: 10, textTransform: "none" }}
                  onClick={() =>
                    this.props.handleClick(currentUser.meaning_progress.w2, "w2")
                  }
                >
                  Resume last assignment
                </Button>
      ...
      } else if (currentUser.meaning_score.length === 1) {
